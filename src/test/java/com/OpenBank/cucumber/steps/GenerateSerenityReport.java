...
public class GenerateSerenityReport extends AbstractMojo {

    private final static Logger LOGGER = LoggerFactory.getLogger(GenerateSerenityReport.class);
    ...
    public void execute() throws MojoExecutionException {
    	System.out.println("before prepareexecute");
    	prepareExecution();
    	System.out.println("After prepareexecute");
        try {
    ...
    public void generateHtmlStoryReports() throws IOException {
    	System.out.println("Target Folder");
        getReporter().setSourceDirectory(new File("./target/site/serenity"));
    	System.out.println("Dest Folder");

        getReporter().setOutputDirectory(new File("./target/generated-sources"));
    	System.out.println("Reached Folder");
...
//        getReporter().setTags(tags);
        ...
        if (generateOutcomes) {
        	System.out.println("Reached Folde222r");

            getReporter().setGenerateTestOutcomeReports();
            
        	System.out.println("Reached Folder555");

        }
        System.out.println("Reached Folder777");
        
        getReporter().generateReportsForTestResultsFrom(new File("./target/site/serenity"));
        System.out.println("Reached Folder7776565");
